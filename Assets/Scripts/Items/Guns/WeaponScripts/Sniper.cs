...
public class Sniper : HitscanWeapon
{
    ...
    //    sniperScopeOverlay = Instantiate(sniperScopeOverlay, canvas.transform.position, Quaternion.identity);
    //    sniperScopeOverlay.GetComponent<RectTransform>().localScale = new Vector3(1, 1, 1);
    //    sniperScopeOverlay.transform.SetParent(canvas.transform);
