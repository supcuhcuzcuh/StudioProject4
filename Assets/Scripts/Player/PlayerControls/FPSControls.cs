...
public class FPSControls : Entity
{
    ...
    void Start()
    {
        ...
        //shootControl.SubscribeShootResponse(perlinNoiseShake);
        //shootControl.SubscribeShootResponse(headbobShake);
        //shootControl.SubscribeShootResponse(shootControl.currWeapon);
